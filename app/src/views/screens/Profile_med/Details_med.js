...
const Details_med = ({navigation, route}) => {
      ...
      <View style={{height : 400, backgroundColor: COLORS.background}}>
        ...
        <View style={style.detailsContainer}>
          ...
          <View
            ...
            <Text style={{fontSize: 12, color: COLORS.dark}}>{categorie.type}</Text>
            <Text style={{fontSize: 13, color: COLORS.dark}}>{categorie.age}</Text>
          </View>
